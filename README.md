...
| Virtual Private Cloud (VPC)                  | Amazon VPC                                                                                              | Azure Virtual Networks (VNet)                                        | Google VPC                     | Virtual Cloud Network                                                             |
...
| Reserved  IP address<br>(within each subnet) | AWS reserves 5 IP addresses                                                                             |                                                                      |                                | reserves 3 IP addresses                                                           |
...
| Static IP address                            | You can assign a static IPv4    <br>with Elastic IP address                                             | You can assign a static IPv4 and IPv6 address <br>to your resources. |                                |                                                                                   |
...
| Route Table                                  | By default the main route table. <br>You can create custom one.                                         | Route tables are not automatically associated                        |                                | Default Route Table without local route                                           |
